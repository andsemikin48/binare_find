...
Пространственная сложность: O(1), так как используется фиксированное
количество дополнительной памяти.
Для линейного:
Лучший случай(искомое в начале) - О(1), худший случай О(n).
То же для пространства увеличение идет линейно.
